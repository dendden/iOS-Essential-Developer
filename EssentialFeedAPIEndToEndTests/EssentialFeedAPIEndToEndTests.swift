...
//
//  Created by Denys Triasunov on 18.05.2024.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case .success(let images):
            XCTAssertEqual(images.count, 8, "Expected 8 images in the test account feed")
    ...
    private func id(at index: Int) -> UUID {
        ...
        return UUID(uuidString: allExpectedIDs[index])!
    }
    
    private func description(at index: Int) -> String? {
        let allExpectedDescriptions = [
            "Description 1",
            nil,
            "Description 3",
            nil,
        ...
        return allExpectedDescriptions[index]
    }
    
    private func location(at index: Int) -> String? {
        let allExpectedLocations = [
            "Location 1",
            "Location 2",
            nil,
            nil,
        ...
        return allExpectedLocations[index]
    }
