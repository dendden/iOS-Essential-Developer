...
//  EssentialFeedTests
//
//  Created by Denys Triasunov on 10.07.2024.
//
...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        let firstInsertionError = insert((uniqueImagesFeed().local, Date()), into: sut)
    ...
    @discardableResult
    private func insert(_ cache: (feed: [LocalFeedImage], timestamp: Date), into sut: CodableFeedStore, file: StaticString = #filePath, line: UInt = #line) -> Error? {
